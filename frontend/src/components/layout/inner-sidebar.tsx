...
const InnerSidebar = () => {
  ...
  return (
    <>
      ...
      >
        <Sidebar collapsible="none" className="border-x-1 border-gray-500/40 relative min-h-svh max-h-svh w-full md:w-(--sidebar-width) lg:w-[20rem] box-border">
              ...
              <SidebarContent className="gap-0 mt-14">
                <SidebarMenu>
                  <SidebarMenuItem className='my-2 mx-4'>
                    <SidebarMenuButton className='h-10' onClick={() => setChat(null)}>
                      <Friends size={20}/>
                      <p>Friends</p>
                    </SidebarMenuButton>
                  </SidebarMenuItem>
